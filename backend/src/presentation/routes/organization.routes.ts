...
import { createOrganizationSchema, editOrganizationSchema, upgradePlanSchema, assignSalesmanSchema, blockCustomerSchema, addContactPersonSchema, } from '../validators/organization.validator';
